...
- name: Amaia Arranz-Otaegui
  ...
  affiliation: 
    - name: University of the Basque Country
      country: Spain
abstract: |
  This appendix describes ecological niche models of 56<!-- TODO keep updated -->
  ...
  are achived with Zenodo at <https://doi.org/> <!-- TODO insert Zenodo DOI -->
format:
  html:
    toc: true
execute:
...
archaeo_flora <- read_tsv(
  derived_data("archaeo_flora_predictions.tsv"),
  col_types = cols(
    ...
    climate_period = col_character(),
    pred_present = col_logical(),
    pred_absent = col_logical()
  )
)
...
content <- pmap(
  flora, 
  function(taxon, taxon_detail, occ, niche, palaeodist, ...) {
    archaeo <- archaeo_flora[archaeo_flora$taxon == taxon,]
    knitr::knit_child(
