...
- [ ] Figures
  - [x] fig-region
  - [x] fig-occ
  - [x] tbl-results-summary
  - [ ] tbl-predictors
  - [x] palaeodist figs
- [ ] Outstanding TODOs
- [ ] Add missing references
- [ ] Copyedit
  - [ ] Replace "see below" etc. with section links
...
These species supported uniquely dense and complex Late Epipalaeolithic (15–11.7 ka) societies based on intensive foraging [@cite] and eventually pre-domestication cultivation [@cite].
...
Modelling the spread of crops has been another significant archaeological application [e.g. @CremaEtAl], though not as yet applied to West Asia.
...
This was based on dataset collated from three previously published regional archaeobotanical databases: ADEMNES [@ADEMNES], ORIGINS [@ORIGINS], and COMPAG [@COMPAG].
...
<!-- TODO expand/rewrite -->
Our results for the Levant are consistent with the current understanding of this region as developing early intensive foraging economies [the Natufian culture, @cite] and as a centre of origin of agriculture [@cite].
Within the Levant, many species show moderate reductions in ranges over the Pleistocene/Holocence boundary, retreating from the Badia/transjordan region [e.g. @fig-palaeodist-barely-levant].
...
Multiple lines of archaeological evidence have emerged that point away from this hypothesis and towards a more geographically diverse origin [@Asouti2006; @cites], but it remains the area with some of the earliest clear evidence of domestication [@ZoharyEtAl2012; @KabukcuEtAl2021; @UlasEtAl2024].
...
"All models are wrong" [@cite], but the performance of our models on independent test datasets give confidence in its predictions, which are plausible and consistent with broad-scale patterns in the archaeological record.
...
Though we have benefitted from the relatively good state of publication of archaeobotanical compilations in our region of study [@ADEMNES; @COMPAG; @ORIGINS], 
