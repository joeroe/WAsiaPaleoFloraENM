...
* Review: @FranklinEtAl2015
* In SW Asia: @ConollyEtAl2012 (first use ever??), @CollinsEtAl2018
* Varying uses: to reconstruct human niches (esp. in Palaeolithic), to reconstruct spread of (esp. domestic) species from archaeological record, or to reconstruct wild ranges from modern occurrences and palaeoclimate (our approach)
* Caveats
