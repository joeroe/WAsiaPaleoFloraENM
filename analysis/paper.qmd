---
title: Biogeography of crop progenitors and wild plant resources in West Asia, 21–8.3 ka
date: today
author: 
- name: Joe Roe
  id: jr
...
flora <- read_tsv(derived_data("flora_occ_count.tsv"))
```
...
flora <- nest(read_tsv(derived_data("flora_occ.tsv")), occ = gbif_key:latitude)
```
