...
One notable exception is the wild ancestor of chickpea (*Cicer reticulatum*), which is predicted to have a distribution centered on Northern Mesopotamia but encompassing much of the the 'hilly flanks' (except the southern Levant, @fig-chickpea-rye). 
...
```{r fig.height=10, fig-palaeodist-barely-levant, eval=FALSE, cache=TRUE}
