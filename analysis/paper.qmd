...
West Asia is part of the native range of a remarkable number of domesticable plant species, including wild relatives of wheat, barley, peas, lentils, and other crops of global importance [@HarlanZohary1966; @ZoharyHopf2000; @Diamond2002].
These species supported uniquely dense and complex Late Epipalaeolithic [15–11.7 ka, @BarYosef1998; @MaherEtAl2012] societies based on foraging [@HillmanEtAl1989; @Colledge2001; @WeissEtAl2004] and eventually plant management and pre-domestication cultivation [@Colledge2001; @WeissEtAl2006; @Harris2007; @WillcoxEtAl2008].
The first agro-ecosystems emerged as these plants were domesticated in the Pre-Pottery Neolithic period (11.7–8.5 ka), shaped by the broader ecosystem in which it was embedded.
...
This is perhaps relevant to rye's unusual domestication history, as a crop of West Asian origin that was intensively exploited [@HillmanEtAl2000; @DoucheWillcox2018] but apparently not first cultivated until much later than the 'founder crops', in Europe [@SchreiberEtAl2021].
...
However, these dynamics are not seen in the majority of crop progenitors and may also have involved other factors, such as changes in cultural food preferences.
